    ...
    <div className="flex justify-between items-center mx-auto max-w-lg sm:max-w-6xl">
      ...
      <div className="flex items-center space-x-2">
        ...
        <div className=" transition-colors duration-500 font-mono">
          <span className="bg-purple-900 dark:bg-amber-200 rounded px-2 py-1 text-amber-200 dark:text-black font-extrabold mr-0.5 tracking-wider text-2xl">RaceTo</span>
